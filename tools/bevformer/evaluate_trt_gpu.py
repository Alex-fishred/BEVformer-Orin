...
def parse_args():
    ...
    parser.add_argument("trt_model", default="checkpoints/tensorrt/bevformer_small_epoch_24.trt",help="checkpoint file")
...
def main():
    ...
    print("\n")
    print('模型消耗GPU: ',torch.cuda.max_memory_allocated(0))
    kwargs = {}
